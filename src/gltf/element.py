...
from src.gltf.helpers import speckle_mesh_to_trimesh
from src.gltf.instances import combine_transform_matrices
...
def speckle_to_element(
    ...
    display_value = getattr(base, "displayValue", None)
